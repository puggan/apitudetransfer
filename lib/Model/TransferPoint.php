...
/**
 * TransferPoint Class Doc Comment
 *
 * @category Class
 * @description The Transfer Point Object
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransferPoint implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransferPoint';
...
self::TYPE_GPS,        ];
     ...
     * Sets description
     *
     * @param string $description Transfer point description
     *
     * @return $this
     */
